...
A.Ship.prototype.rotate = function (direction) {
  ...
  setInterval((function () {
    if (key.isPressed("left") === false && key.isPressed("right") === false) {
      this.rotation = 0;
    }
  }).bind(this), 0);
};
...
A.Ship.prototype.draw = function (ctx) {
  ...
  ctx.moveTo(this.pos[0] + 20 * Math.cos(this.orientation), this.pos[1] - 20 * Math.sin(this.orientation));
  ctx.lineTo(this.pos[0] + 10 * Math.cos(this.orientation + 2 * Math.PI / 3), this.pos[1] - 10 * Math.sin(this.orientation + 2 * Math.PI / 3));
  ctx.lineTo(this.pos[0] + 7 * Math.cos(this.orientation + 2 * Math.PI / 3), this.pos[1] - 7 * Math.sin(this.orientation + 2 * Math.PI / 3));

  ctx.lineTo(this.pos[0] + 7 * Math.cos(this.orientation + 4 * Math.PI / 3), this.pos[1] - 7 * Math.sin(this.orientation + 4 * Math.PI / 3));
  ctx.lineTo(this.pos[0] + 10 * Math.cos(this.orientation + 4 * Math.PI / 3), this.pos[1] - 10 * Math.sin(this.orientation + 4 * Math.PI / 3));
  ctx.lineTo(this.pos[0] + 20 * Math.cos(this.orientation), this.pos[1] - 20 * Math.sin(this.orientation));
